...
const ClientSidebar = ({ isOpen, setIsOpen }) => {
  ...
  const menuItems = [
    { name: 'Dashboard', icon: LayoutGrid, path: '/client/dashboard' },
    { name: 'Post Project', icon: PlusCircle, path: '/client/post-project' },
    { name: 'My Projects', icon: Files, path: '/client/my-projects' },
    { name: 'Bids Received', icon: Gavel, path: '/client/bids' },
